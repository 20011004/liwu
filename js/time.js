function showTime() { 
	...
	var startDate = new Date(2019, 11, 04);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear 乔:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----爱你的航   2020-03-12</c>"; 
